...
$('.header__slider').on('beforeChange', function (event, slick, currentSlide, nextSlide) {
	$('.header__map svg .line-anim.active').removeClass('active');
	$('.header__map svg .shore.active').removeClass('active');
	$('.header__map svg .point.active').removeClass('active');
	$('.animL-' + nextSlide).addClass('active');
	$('.shore-' + nextSlide).addClass('active');
	$('.point-' + nextSlide).addClass('active');
});
...
$(document).ready(function () {
	$(".surf-slider").slick({
		...
		infinite: true,
		focusOnSelect: true,
		asNavFor: '.map-slider, .surf__coordinates',
		responsive: [
			{
				breakpoint: 1150,
				settings: {
...
//Date
const date = new Date();
document.querySelector(".header__date p").innerHTML = date.getDate();
...
// renderCalendar();
//Counter
$('<div class="quantity-nav"><div class="quantity-button quantity-up"><i class="fas fa-plus"></i></div><div class="quantity-button quantity-down"><i class="fas fa-minus"></i></div></div>').insertAfter('.quantity input');
...
// $(".quantity-button, .slick-arrow").on("click", function () {
// 	let summ = $(".night").val() * $(".summ").data("price") + $(".guest").val() * $(".summ").data("price");
// 	$(".summ").html(summ);
// });
// let summ = $(".night").val() * $(".summ").data("price") + $(".guest").val() * $(".summ").data("price");
// $(".summ").html(summ);
...
$('.quantity-button').on('click', function () {
	let parents = $(this).parents('.sleep-slider__bottom');
	let summ = ($('.summ', parents).data('price') * $('.night', parents).val() * $('.guest', parents).val());
